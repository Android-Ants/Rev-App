...
public class SignInActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // binding.webView.getSettings().setUserAgentString("Chrome/56.0.0 Mobile");
        binding.webView.loadUrl("https://accounts.google.com/o/oauth2/auth?response_type=code&client_id=841525552075-lmtdplark7r3m4t69pocukvjs6bgeeau.apps.googleusercontent.com&redirect_uri=http://localhost&state=foobar&scope=https://www.googleapis.com/auth/drive");
